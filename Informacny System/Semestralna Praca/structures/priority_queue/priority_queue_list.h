...
namespace structures
{
	...
	template<typename T>
	inline int PriorityQueueList<T>::indexOfPeek() const // pomocna funkcia - bude prekryta potomkami
	{
		//TODO 06: PriorityQueueList
		if (list_->size() <= 0) {
	...
	template<typename T>
	inline T PriorityQueueList<T>::pop() // vratit prvok s najvyssou prioritou - odobrat prvok na nejakom indexe pomocou funkcie removeAt
	{
		//TODO 06: PriorityQueueList
		PriorityQueueItem<T>* pom = list_->removeAt(indexOfPeek());
	...
	template<typename T>
	inline T & PriorityQueueList<T>::peek() // - operator[indexofpeek] 
	{
		//TODO 06: PriorityQueueList
